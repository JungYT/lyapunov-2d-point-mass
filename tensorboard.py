...
fig, ax = plt.subplots(3, 1, figsize=set_size())
line1, = ax[0].plot(N1[:,1], N1[:,2], 'g-.')
line2, = ax[1].plot(L1[:,1], L1[:,2], 'r')
line3, = ax[2].plot(EQL2[:,1], EQL2[:,2], 'b--')
ax[0].legend(handles=(line1, line2, line3),
                labels=('N-reward', 'L-reward', 'EQL-reward'), bbox_to_anchor=(-0.05, -3.3), loc='center left', ncol=2)
...
# ax[0].set_title('Return values histories vs. iteration')
